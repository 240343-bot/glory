...
const SUPABASE_URL = 'https://eigihgnbeusdrkhziihd.supabase.co';
const SUPABASE_KEY = 'sb_publishable_U80g8blIH1MsOA_lOiaWmQ_YZNgALrb';
const SITE_URL = 'https://240343-bot.github.io/glory';
...
async function loadRating() {
    ...
    if (!data || data.length === 0) {
        ratingList.innerHTML = '<div style="padding: 20px; text-align: center;">Нет данных</div>';
        return;
    }
